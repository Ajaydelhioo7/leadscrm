...
<div class="container mt-5">
    <h3 class="text-center">Manage Statuses</h3>
    <div class="text-right mb-3">
        <a href="add_status.php" class="btn btn-primary">Add Status</a>
    </div>
        ...
        <tbody>
            <?php while ($row = $result->fetch_assoc()): ?>
                <tr>
                    ...
                    <td>
                        <a href="edit_status.php?id=<?php echo $row['id']; ?>" class="btn btn-warning btn-sm">Edit</a>
                        <form method="POST" action="manage_status.php" style="display:inline-block;">
