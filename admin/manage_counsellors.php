...
<div class="container mt-5">
    ...
    <div class="text-right mb-3">
        <a href="add_counsellor.php" class="btn btn-primary">Add Counsellor</a>
    </div>
        ...
        <tbody>
            <?php while ($row = $result->fetch_assoc()): ?>
                <tr>
                    ...
                    <td>
                        <a href="edit_counsellor.php?id=<?php echo $row['id']; ?>" class="btn btn-warning btn-sm">Edit</a>
                        <form method="POST" action="manage_counsellors.php" style="display:inline-block;">
